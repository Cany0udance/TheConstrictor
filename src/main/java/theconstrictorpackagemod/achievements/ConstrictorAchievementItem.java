...
public class ConstrictorAchievementItem {
    ...
    public ConstrictorAchievementItem(String title, String desc, String key, TextureAtlas.AtlasRegion unlockedImage, TextureAtlas.AtlasRegion lockedImage) {
