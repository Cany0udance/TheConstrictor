...
public class StatsScreenScrollbarPatch {
    ...
    public static void Postfix(StatsScreen __instance) {
        ...
        float constrictorAchievementGrid = theconstrictormod.constrictorAchievementGrid.calculateHeight();
        ReflectionHacks.setPrivate(__instance, StatsScreen.class, "scrollUpperBound", currentUpperBound + (constrictorAchievementGrid + 50F));
    }
}