...
public class RenderAchievementGrid {
    ...
    static {
        uiStrings = CardCrawlGame.languagePack.getUIString("TheConstrictor:AchievementGrid");
    }
    ...
    public static void Insert(StatsScreen __instance, SpriteBatch sb, @ByRef float[] renderY) {
        ...
        theconstrictormod.constrictorAchievementGrid.render(sb, renderY[0]);
        renderY[0] -= theconstrictormod.constrictorAchievementGrid.calculateHeight();
