...
@SpireInitializer
public class theconstrictormod implements
    ...
    private static final String resourcesFolder = "theconstrictorpackagemod";
    ...
    private static void addColor(AbstractCard.CardColor cardColor, com.badlogic.gdx.graphics.Color cardColor1, String bgAttack, String bgSkill, String bgPower, String energyOrb, String bgAttackP, String bgSkillP, String bgPowerP, String energyOrbP, String smallOrb) {
    }

    public theconstrictormod() {
...
//    @Override
//    public void receiveEditCards(new AutoAdd(modID) //Loads files from this mod
//        .packageFilter(BaseCard .class) //In the same package as this class
//        .setDefaultSeen(true) //And marks them as seen in the compendium
//        .cards(); //Adds the cards) { //somewhere in the class
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(theconstrictormod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
