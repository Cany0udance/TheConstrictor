...
public class MyCharacter extends CustomPlayer {
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass theconstrictor;
        @SpireEnum(name = "theconstrictor_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "theconstrictor_COLOR") @SuppressWarnings("unused")
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(BaseStrikePog.ID);
        retVal.add(BaseStrikePog.ID);
        retVal.add(BaseStrikePog.ID);
        retVal.add(BaseStrikePog.ID);
        retVal.add(BaseBlock.ID);
        retVal.add(BaseBlock.ID);
        retVal.add(BaseBlock.ID);
        retVal.add(BaseBlock.ID);
        retVal.add(MyCard2.ID);
        retVal.add(SinkingFeeling.ID);
    ...
    public Texture getCutsceneBg() {
        return ImageMaster.loadImage("theconstrictorpackagemod/character/select/GoldBg.png");// 307
    }

    @Override
    public List<CutscenePanel> getCutscenePanels() {
        List<CutscenePanel> panels = new ArrayList();// 312
        panels.add(new CutscenePanel("theconstrictorpackagemod/character/select/Constrictor1.png"));// 313
        panels.add(new CutscenePanel("theconstrictorpackagemod/character/select/Constrictor2.png"));// 314
        panels.add(new CutscenePanel("theconstrictorpackagemod/character/select/Constrictor3.png"));// 315
        return panels;// 316
    }
